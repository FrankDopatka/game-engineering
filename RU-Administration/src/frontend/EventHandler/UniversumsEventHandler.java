...
public class UniversumsEventHandler extends EventHandler {
	...
	//Löscht die alte Felder zugehörichkeit beim änderen einse Feldes
	...
	//Gibt für Bi-Direktionale Wurmlöcher die Ziel Koordinaten aus
	...
	//Bearbeitungs boduf für ein Planeten oder Mond
	...
	//Aufwahl für die Bearbeitung der Wurmlöcher
	private void Wurmlochbearbeiten(Platz feld) {
		MenuRechts menu = frontend.getMenuRechts();

		Raum raum = (Raum) feld;
		int wurmlochID = 1;
		for (int id : frontend.getUniversum().getWurlochID()) {
			wurmlochID++;
		}
